...
EXTENTS = {
    ...
    'mvd': {
        'mvp': [
            ...
            ['Mississippi River', [24000, 2202000, 564000, 2698000]],
            ['Red Lake River', [-82000, 2710000, 152000, 2820000]],
            ['Park River', [-180000, 2814000, -80000, 2868000]],
            ['Mississippi Headwaters', [44000, 2616000, 254000, 2760000]],
            ['Minnesota River', [-112000, 2244000, 234000, 2602000]],
            ['Red River', [-356108, 2493740, 150081, 2949779]],
            ['Sheyenne River', [-352000, 2578000, -58000, 2818000]],
    ...
    'nwd': {
        'nwd': [
            ['To Garrison River', [-800000, 2422000, -370000, 2936000]],
            ['To Oahe', [-818000, 2208000, -220000, 2782000]],
            ['To Fort Randall', [-644000, 2188000, -184000, 2452000]],
            ['To Gavins Point', [-712000, 2112000, -114000, 2292000]],
            ['Gavins to Sioux City', [-148000, 2136000, 38000, 2516000]],
        ],
        'nwk': [
            ['Republican River', [-670000, 1772000, -64000, 2024000]],
            ['Smokey River', [-588000, 1702000, -60000, 1896000]],
            ['Osage River', [-24000, 1552000, 360000, 1770000]],
            ['Little Charlton River', [254000, 1798000, 310000, 1912000]],
            ['Kansas River', [-84000, 1730000, 130000, 1884000]],
            ['Charlton River', [180000, 1810000, 294000, 2012000]],
            ['Little Blue River', [118000, 1750000, 158000, 1806000]],
            ['Little Platte River', [104000, 1798000, 148000, 1868000]],
        ],
        'nwo': [
            ['Milk River', [-1296000, 2800000, -746000, 3006000]],
            ['Heart River', [-568000, 2602000, -366000, 2714000]],
            ['Grand River', [-606000, 2496000, -364000, 2614000]],
            ['Rapid River', [-642000, 2332000, -526000, 2392000]],
            ['Marias River', [-1304000, 2830000, -1068000, 2998000]],
            ['Upper Missouri River', [-1394000, 2460000, -740000, 2892000]],
            ['North Platte River', [-1080000, 1964000, -384000, 2298000]],
            ['Big Horn River', [-1188000, 2226000, -562000, 2806000]],
            ['James River', [-316000, 2204000, -88000, 2770000]],
        ...
        'nws': [
            ...
            ['Skagit River', [-1962000, 3056000, -1808000, 3140000]],
        ...
        'nww': [
            ...
            ['Boise River', [-1676000, 2418000, -1548000, 2508000]],
    ...
    'spd': {
        'spa': [
            ...
            ['Rio Grande River', [-1012000, 1384000, -794000, 1766000]],
            ['Rio Hondo River', [-914000, 1158000, -770000, 1226000]],
        ],
        'spk': [
