...
EXTENTS = {
    ...
    'mvd': {
        'mvp': [
            ['Red River', [-356108, 2493740, 150081, 2949779]],
            # ['Red River', [-351108, 2498740, 145082, 3000000]], v3
            # ['Red River', [-351108, 2498740, 450812, 2944780]], v2
            # ['Red River', [-234000, 2494000, 68000, 2896000]], v1
        ],
        'mvs': [
